...
const sttaddr = "0x99528bc9a58b1c539c3ad883b48ae6487ebe6be0";
const sttabi = [{
    "constant": false,
    "inputs": [{
        "name": "_refer",
...
function getreflink() {
    document.getElementById('refaddresscopy').value = 'https://degodex.com/?ref=' + document.getElementById('refaddress').value;
}
